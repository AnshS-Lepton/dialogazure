...
namespace Models
{
    public class GipipeMaster : GipipeTemplateMaster, IProjectSpecification,IOwnershipInfo,IAcquireFrom,IReference,IGeographicDetails,IAdditionalFields
    {
        [Key]
        ...
        public string gipipe_name { get; set; }
       ...
       // [Required]
        ...
        public string gipipe_type { get; set; }
        ...
        [NotMapped]
        public IList<DropDownMaster> GipipeTypeIn { get; set; }
        [NotMapped]
        public IList<DropDownMaster> GipipeColorIn { get; set; }
        [NotMapped]
