...
namespace Models
{
    public class ConduitMaster : ConduitTemplateMaster, IProjectSpecification, IOwnershipInfo,IAcquireFrom,IReference,IGeographicDetails,IAdditionalFields
    {
        [Key]
        ...
        //public string Conduit_category { get; set; }
        ...
        public string conduit_type { get; set; }
        ...
        [NotMapped]
        public IList<DropDownMaster> ConduitTypeIn { get; set; }
        [NotMapped]
        public IList<DropDownMaster> ConduitColorIn { get; set; }
        [NotMapped]
