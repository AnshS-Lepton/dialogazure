...
namespace Models
{
    ...
    public interface ISite
    {
        ...
        string tx_ring { get; set; }
        string province { get; set; }
        string district { get; set; }
        string depot { get; set; }
        string ds_division { get; set; }
        string local_authority { get; set; }
    ...
    public class PEPMaster : PEPTemplateMaster, IProjectSpecification, IOwnershipInfo, IAcquireFrom, IReference, IGeographicDetails, IAdditionalFields, ICustomCoordinate
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public int system_id { get; set; }
        ...
        public string pep_name { get; set; }
        public double latitude { get; set; }
        public double longitude { get; set; }
        public int province_id { get; set; }
        public int region_id { get; set; }
        public string address { get; set; }
        public string remarks { get; set; }
        public string pep_height { get; set; }
