...
namespace Models
{
    public class AssociationReportLog
    {
    ...
    public class AssociationReportLogVM
    {
        public List<AssociationReportLogInfo> ExportLog { get; set; }
        public CommonGridAttributes objGridAttributes { get; set; }
        public AssociationReportLogVM()
        {
    ...
    public class AssociationReportLogInfo
    {
