...
end_reading,structure_id,utilization,duct_id,trench_id,is_used,ownership_type,bom_sub_category,AUDIT_ITEM_MASTER_ID, source_ref_type)

select '',v_arow_network_id.network_code,v_arow_network_id.network_code,v_arow_start_closure.network_id,v_arow_end_closure.network_id,total_core,no_of_tube,no_of_core_per_tube,ST_Length(ST_GeomFromText('LINESTRING('||p_line_geom||')',4326),false),v_calculated_length,
cable_type,specification,category,subcategory1,subcategory2,subcategory3,item_code,
...
0,0,0,'L',0,0,true,'Own','Proposed',AUDIT_ITEM_MASTER_ID,'WEB' from item_template_cable where created_by = p_user_id order by modified_on desc limit 1
