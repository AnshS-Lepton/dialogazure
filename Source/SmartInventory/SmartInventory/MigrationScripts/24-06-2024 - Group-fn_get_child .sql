-- FUNCTION: public.fn_get_child_clone_list_nt(character varying, integer)

-- DROP FUNCTION IF EXISTS public.fn_get_child_clone_list_nt(character varying, integer);
...
ALTER FUNCTION public.fn_get_child_clone_list_nt(character varying, integer)
    OWNER TO postgres;
