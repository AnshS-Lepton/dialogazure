...
sql:=sql||' select associated_network_id as network_id,associated_display_name as display_name,false is_child_entity,true is_associated_entity, associated_entity_type as entity_type ,associated_system_id as system_id,ld.layer_title
