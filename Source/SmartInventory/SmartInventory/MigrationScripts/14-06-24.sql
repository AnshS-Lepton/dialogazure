...
select system_id into v_entity_two_system_id from att_details_cable where network_id=p_entity_one_network_id;
...
PERFORM fn_associate_fiber_link_cable(v_entity_one_system_id,arow.link_system_id,arow.fiber_number,'A');
...
PERFORM fn_associate_fiber_link_cable(v_entity_two_system_id,arow.link_system_id,arow.fiber_number,'A');
