-- FUNCTION: public.fn_network_planning_save_auto_planning(character varying, character varying, boolean, boolean, character varying, double precision, double precision, integer, character varying, character varying, character varying, character varying, double precision, character varying, integer, character varying, integer, boolean, double precision)

-- DROP FUNCTION IF EXISTS public.fn_network_planning_save_auto_planning(character varying, character varying, boolean, boolean, character varying, double precision, double precision, integer, character varying, character varying, character varying, character varying, double precision, character varying, integer, character varying, integer, boolean, double precision);

CREATE OR REPLACE FUNCTION public.fn_network_planning_save_auto_planning(
	p_plan_mode character varying,
	p_cable_type character varying,
	is_create_trench boolean,
	is_create_duct boolean,
	p_line_geom character varying,
	p_cable_length double precision,
	p_distance double precision,
	p_user_id integer,
	p_plan_name character varying,
	p_startpoint character varying,
	p_endpoint character varying,
	p_end_point_type character varying,
	p_end_point_buffer double precision,
	p_edit_path character varying,
	p_end_point_entity_id integer,
	p_end_point_entity_type character varying,
	p_temp_plan_id integer,
	p_is_loop_required boolean,
	p_loop_length double precision)
...
FROM item_template_manhole where created_by=p_user_id limit 1 RETURNING system_id,network_id,latitude,longitude into v_arow_middle_manhole;
...
SELECT true,v_audit_item_master_id_point_entity,'Own',pole_type,v_arow_network_id.message,v_arow_network_id.message,
st_x(v_current_point_geom),st_y(v_current_point_geom),
v_region_province.province_id,v_region_province.region_id, specification, category, subcategory1, subcategory2, subcategory3,
...
st_y(v_current_point_geom),v_region_province.province_id,v_region_province.region_id, specification, category, subcategory1, subcategory2,
subcategory3,item_code,vendor_id, 0, 0, 0, 0, 0,0, 'A',p_user_id, now(),'P',v_arow_network_id.o_p_system_id,
v_arow_network_id.o_p_network_id,v_arow_network_id.o_p_entity_type,v_arow_network_id.o_sequence_id, 0, 0, 0, 0,'planning',p_plan_id
FROM item_template_manhole where created_by=p_user_id limit 1 RETURNING system_id,network_id,latitude,longitude into v_arow_manhole;
...
'P',fn_get_display_name(v_arow_manhole.system_id, v_point_entity));
...
SELECT true,v_audit_item_master_id_point_entity,'Own',pole_type,v_arow_network_id.message,v_arow_network_id.message,
st_x(v_current_point_geom),st_y(v_current_point_geom),v_region_province.province_id,v_region_province.region_id, specification, category,
subcategory1, subcategory2, subcategory3,item_code, vendor_id, 0, 0, 0, 0, 0,0, 'A',p_user_id, now(),'P',
...
0, 0, 0,'planning',p_plan_id FROM item_template_pole where created_by=p_user_id limit 1 RETURNING system_id,network_id,latitude,longitude
into v_arow_manhole;
...
v_arow_network_id.sequence_id,no_of_ports,0,0,0,0,0,no_of_input_port,no_of_output_port,true,false,'planning',p_plan_id
...
created_by,common_name, network_status,no_of_ports,display_name)
...
fn_get_display_name(v_arow_closure.system_id, 'SpliceClosure'));
...
ALTER FUNCTION public.fn_network_planning_save_auto_planning(character varying, character varying, boolean, boolean, character varying, double precision, double precision, integer, character varying, character varying, character varying, character varying, double precision, character varying, integer, character varying, integer, boolean, double precision)
    OWNER TO postgres;
