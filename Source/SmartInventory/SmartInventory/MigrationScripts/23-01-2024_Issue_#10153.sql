...
----------------------------------------#10153 - Approval button disabled for building -----------------------------------------
update module_master set is_active=true where module_name='Approve/Reject Building' and module_abbr='ARP'

----------------------------------#10096 - Add column in temp_fiber_link table -------------------------------------------------
alter table temp_fiber_link add link_prefix CHARACTER VARYING;

----------------------------------#10096 - Modification in function 'fn_bulk_upload_fiberlink_insert' -------------------------------------------------
...
BEGIN
  ...
  fiber_link_status,main_link_type,main_link_id,link_prefix)
  
 SELECT Network_id:: character VARYING,(link_prefix || link_id) link_id,Link_Type,link_name,start_point_type,end_point_type,start_point_network_id,
