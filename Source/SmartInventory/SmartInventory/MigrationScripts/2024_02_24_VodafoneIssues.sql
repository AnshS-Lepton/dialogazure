...
INSERT INTO public.associate_entity_master ( layer_id, associate_layer_id, layer_subtype, is_enabled, created_on, created_by, modified_on, modified_by, is_snapping_enabled, is_shifting_allowed) 
VALUES( (select  layer_id from layer_details where layer_name = 'FDB'), (select  layer_id from layer_details where layer_name = 'WallMount'), '', true, '2020-02-12 13:52:43.358', 0, '2020-02-12 13:52:43.358', 0, false, false),
((select  layer_id from layer_details where layer_name = 'CDB'), (select  layer_id from layer_details where layer_name = 'WallMount'), '', true, '2020-02-12 13:52:43.358', 0, '2020-02-12 13:52:43.358', 0, false, false),
((select  layer_id from layer_details where layer_name = 'BDB'), (select  layer_id from layer_details where layer_name = 'WallMount'), '', true, '2020-02-12 13:52:43.358', 0, '2020-02-12 13:52:43.358', 0, false, false),
((select  layer_id from layer_details where layer_name = 'SpliceClosure'), (select  layer_id from layer_details where layer_name = 'WallMount'), '', true, '2020-02-12 13:52:43.358', 0, '2020-02-12 13:52:43.358', 0, false, false);
