-- This function is Changed by Abhishek
-- DROP FUNCTION public.fn_splicing_save_osp_split_connection(varchar, varchar, int4, int4, varchar, varchar, int4, varchar);

CREATE OR REPLACE FUNCTION public.fn_splicing_save_osp_split_connection(p_cable_one_network_id character varying, p_cable_two_network_id character varying, p_old_cable_system_id integer, p_split_entity_system_id integer, p_split_entity_network_id character varying, p_split_entity_type character varying, p_user_id integer, p_splicing_source character varying)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$
declare 
...
from att_details_cable_info b where b.cable_id=p_old_cable_system_id and a.fiber_number=b.fiber_number and a.cable_id=v_cable_one_system_id;

update att_details_cable_info a set link_system_id=b.link_system_id
from att_details_cable_info b where b.cable_id=p_old_cable_system_id and a.fiber_number=b.fiber_number and a.cable_id=v_cable_two_system_id;
