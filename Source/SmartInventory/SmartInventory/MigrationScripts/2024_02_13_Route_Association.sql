...
INSERT INTO public.layer_action_mapping(
	 layer_id, action_name, is_active, action_sequence, action_title, is_visible, is_isp_action, is_osp_action, action_abbr, action_layer_id, action_module_id,
	is_mobile_action, is_web_action, action_mobile_module_id, res_field_key, is_enable_in_draft, parent_action_id)
	VALUES ((select layer_id from layer_details where layer_name='BDB'), 'RouteAssociate', true, 13, 'FDC Route Association', true, true, true, 'E', 0, (select id from module_master where module_name='Route Associate'), false, true, 
			0, '', false, 0);
...
INSERT INTO public.layer_action_mapping(
	 layer_id, action_name, is_active, action_sequence, action_title, is_visible, is_isp_action, is_osp_action, action_abbr, action_layer_id, action_module_id,
	is_mobile_action, is_web_action, action_mobile_module_id, res_field_key, is_enable_in_draft, parent_action_id)
	VALUES ((select layer_id from layer_details where layer_name='WallMount'), 'RouteAssociate', true, 13, 'WallMount Route Association', true, true, true, 'E', 0, (select id from module_master where module_name='Route Associate'), false, true, 
			0, '', false, 0);
------------------------------------------------------------------------Manhole----------------------------------------------------------------------------
...
INSERT INTO public.layer_action_mapping(
	 layer_id, action_name, is_active, action_sequence, action_title, is_visible, is_isp_action, is_osp_action, action_abbr, action_layer_id, action_module_id,
	is_mobile_action, is_web_action, action_mobile_module_id, res_field_key, is_enable_in_draft, parent_action_id)
	VALUES ((select layer_id from layer_details where layer_name='Manhole'),, 'RouteAssociate', true, 13, 'Manhole Route Association', true, true, true, 'E', 0, (select id from module_master where module_name='Route Associate'), false, true, 
			0, '', false, 0);
-----------------------------------------------------------------------FDB(FAT)--------------------------------------------------------------------------------------
...
INSERT INTO public.layer_action_mapping(
	 layer_id, action_name, is_active, action_sequence, action_title, is_visible, is_isp_action, is_osp_action, action_abbr, action_layer_id, action_module_id,
	is_mobile_action, is_web_action, action_mobile_module_id, res_field_key, is_enable_in_draft, parent_action_id)
	VALUES ((select layer_id from layer_details where layer_name='FDB'), 'RouteAssociate', true, 13, 'FAT Route Association', true, true, true, 'E', 0, (select id from module_master where module_name='Route Associate'), false, true, 
			0, '', false, 0);
----------------------------------------------------------------------------------------------------------------------------------------------------------------
update LAYER_COLUMNS_SETTINGS set is_active=true where setting_type='Info'and column_name='route_id'
----------------------------------------------------------------------------------------------------------------------------------------------------------------
