...
VALUES((select layer_id from layer_details where layer_name = 'SpliceClosure' 
), 'PrimaryAddSplitter', true, 10, 'Add Splitter', true, false, true, 'A', 9, 0, true, true, 0, 'SI_OSP_GBL_NET_FRM_256', false, 0);


INSERT INTO public.layer_action_mapping
(layer_id, action_name, is_active, action_sequence, action_title, is_visible, is_isp_action, is_osp_action, action_abbr, action_layer_id, action_module_id, is_mobile_action, is_web_action, action_mobile_module_id, res_field_key, is_enable_in_draft, parent_action_id)
VALUES((select layer_id from layer_details where layer_name = 'SpliceClosure' 
),'SplitterTemplate', true, 11, 'Splitter Template', true, false, true, 'T', 9, 0, false, true, 0, 'SI_OSP_GBL_NET_FRM_257', false, 0);
...
VALUES((select layer_id from layer_details where layer_name = 'Splitter'),
(select layer_id from layer_details where layer_name = 'SpliceClosure' ), 1, true, true, 'SPLnn', true,false);
