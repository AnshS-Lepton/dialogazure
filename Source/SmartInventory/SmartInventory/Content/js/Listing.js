var ListingPage = function () {
    ...
    this.AE = {
        ...
        "DownloadAssignedRouteIssueReportRM": "#btnDownloadAssignedRouteIssueReportRM",
        "DownloadRouteIssueReportRM": "#btnDownloadRouteIssueReportRM",
        "DownloadTTRouteIssueReport": "#btnDownloadTTRouteIssueReport",
        "DownloadAssignedRouteIssueReportTT": "#btnDownloadAssignedRouteIssueReportTT",
        "DownloadTMRouteIssueReport": "#btnDownloadTMRouteIssueReport",
        "DownloadVTMRouteIssueReport": "#btnDownloadTTAssignedRouteIssueReport",
        "DownloadAdditionalMaterialReport": "#btnDownloadAdditionalMaterialReport"
    ...
    this.bindEvents = function () {
        ...
        $(comp.AE.DownloadReport).on("click", function () {
            ...
            var reportUrl = 'Workforce/DownloadRouteAssignedReport';
            si.DownloadReport(reportUrl);
        });
        $(comp.AE.DownloadUserAttendanceReport).on("click", function () {
            ...
            var reportUrl = 'Workforce/DownloadUserAttendanceReport';
            si.DownloadReport(reportUrl);
        });
        ...
        $(comp.AE.DownloadAssignedRouteIssueReport).on("click", function () {
            ...
            var reportUrl = 'Workforce/DownloadRouteAssignIssueReport';
            si.DownloadReport(reportUrl);
        });
        $(comp.AE.DownloadRouteIssueReport).on("click", function () {
            ...
            var reportUrl = 'Workforce/DownloadRouteIssueReport';
            si.DownloadReport(reportUrl);
        });

        $(comp.AE.DownloadAssignedRouteIssueReportRM).on("click", function () {
            ...
            var reportUrl = 'Workforce/DownloadRouteAssignIssueReportRM';
            si.DownloadReport(reportUrl);
        });
        $(comp.AE.DownloadRouteIssueReportRM).on("click", function () {
            ...
            var reportUrl = 'Workforce/DownloadRouteIssueReportRM';
            si.DownloadReport(reportUrl);
        });

        $(comp.AE.DownloadTTRouteIssueReport).on("click", function () {
            // 
            //totalRowCount and maxExportReportCount defined on specific page for eg: _ViewAssignedRoute.cshtml
            if (totalRowCount > maxExportReportCount) {
                alert("Report Count should be less than " + maxExportReportCount + "");
            ...
            var reportUrl = 'Workforce/DownloadTTRouteIssueReport';
            si.DownloadReport(reportUrl);
        });
        $(comp.AE.DownloadVTMRouteIssueReport).on("click", function () {
            //totalRowCount and maxExportReportCount defined on specific page for eg: _ViewAssignedRoute.cshtml
            if (totalRowCount > maxExportReportCount) {
                alert("Report Count should be less than " + maxExportReportCount + "");
                return false;
            }
            var reportUrl = 'Workforce/DownloadVTMRouteIssueReport';
            si.DownloadReport(reportUrl);
        });
        $(comp.AE.DownloadTMRouteIssueReport).on("click", function () {
            //totalRowCount and maxExportReportCount defined on specific page for eg: _ViewAssignedRoute.cshtml
            if (totalRowCount > maxExportReportCount) {
                alert("Report Count should be less than " + maxExportReportCount + "");
                return false;
            }
            var reportUrl = 'Workforce/DownloadTMRouteIssueReport';
            si.DownloadReport(reportUrl);
        });
        $(comp.AE.DownloadAssignedRouteIssueReportTT).on("click", function () {
            //totalRowCount and maxExportReportCount defined on specific page for eg: _ViewAssignedRoute.cshtml
            if (totalRowCount > maxExportReportCount) {
                alert("Report Count should be less than " + maxExportReportCount + "");
                return false;
            }
            var reportUrl = 'Workforce/DownloadAssignedRouteIssueReportTT';
            si.DownloadReport(reportUrl);
        });
        $(comp.AE.DownloadAdditionalMaterialReport).on("click", function () {
            if (totalRowCount > maxExportReportCount) {
                alert("Report Count should be less than " + maxExportReportCount + "");
                return false;
            }
            var reportUrl = 'Workforce/DownloadAdditionalMaterialReport';
            si.DownloadReport(reportUrl);
        });
    ...
    this.ValidateSearchFilters = function () {
        ...
        if (selStartDate != "" && selEndDate != "") {
            selStartDate = DateFormatter(selStartDate);
            var startDate = new Date(selStartDate);
            selEndDate = DateFormatter(selEndDate);
