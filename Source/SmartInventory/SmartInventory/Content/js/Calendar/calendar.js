...
// $Id: calendar.js,v 1.1 2003/12/08 04:53:09 rizen Exp $
...
Calendar.calDragIt = function (ev) {
	$('.calendar').draggable('disable'); // this will make the calendar non-draggable
	var cal = Calendar._C;
	if (!(cal && cal.dragging)) {
		return false;
	}
...
Calendar.prototype.showAtElement = function (el, opts) {
	...
	Calendar.continuation_for_the_fucking_khtml_browser = function() {
		...
		switch (valign) {
		    case "T": p.y -= h; break;
		    case "B": p.y += (el.offsetHeight - h) / 4; break;  // adjust calendar from top - DeepakB - 17-01-23
			case "C": p.y += (el.offsetHeight - h) / 2; break;  // adjust calendar from top - DeepakB - 17-01-23
