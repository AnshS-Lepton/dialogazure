var FiberLink = function () {
    ...
    this.ActionColumn = function () {
        ...
        $(app.DE.tblFiberLinkGrid + ' tbody tr').each(function (index, value) {
            ...
            rowAction = rowAction + '<i class="cptr icon-Delete ml-05' + (fiber_link_status == "Free" ? "" : "dvdisabled") + '" title="' + MultilingualKey.SI_GBL_GBL_GBL_GBL_002 + '" onclick="fiberLink.deleteFiberLinkById(' + systemId + ')"></i>';
