...
(function (global, factory) {
  ...
  class DelaunayTriangulationBuilder {
    ...
    static extractUniqueCoordinates(geom) {
      ...
      return DelaunayTriangulationBuilder.uniqueSort(coords);
    }
    ...
    setSites() {
      if (arguments[0] instanceof Geometry) {
        ...
        const coords = arguments[0];
        this._siteCoords = DelaunayTriangulationBuilder.uniqueSort(CoordinateArrays.toCoordinateArray(coords));
      }
    }
