...
(function(factory) {
        ...
        init: function (options) {
            return this.each(function () {
                ...
                }
                {
                    ...
                    var inputpicker_div = $("<div id=\"inputpicker-div-" + uuid + "\" class=\"inputpicker-div\" data-uuid=\"" + uuid + "\" style=\"position:relative;overflow:auto;height:auto;\"><span class=\"inputpicker-arrow\" data-uuid=\"" + uuid + "\" onclick=\"$(this).parent().find('input').inputpicker('toggle');event.stopPropagation();\"><b></b></span></div>")
                        .append(input)
                        .on('click', function (e) {
    ...
    function _renderTableHeader(input) {
        var output = "<thead><tr><th>Epsg</th><th>Name</th><th>Area in use</th></tr></thead>";
        //var fields = _set(input, 'fields');
