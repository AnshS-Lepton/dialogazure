...
var splicing = function () {
    ...
    this.cableToCableSplicing = function () {
        ...
        //ajaxReq('Splicing/CableToCable', { objSplicingIn: objSplicingInput }, false , function (data) {
    ...
    this.focusCPEToCustomer = function (ddlId) {
        ...
        if (systemID != '0') {
            ...
            ajaxReq('splicing/getGeometryDetail', { systemId: systemID, entityType: eType, geomType: gType }, true, function (resp) {
                if (resp.status = 'OK') {
    ...
    //            app.gMapObj.pointObj.setAnimation(null);
    ...
    this.showSchematicView = function () {
        ...
        ajaxReq('splicing/EncryptMultiple', { entityid: entityid, entity_type: entity_type, port_no: port_no }, false, function (resp) {
    ...
    this.checkPatchTemplateExist = function (connection, info) {
        ajaxReq('splicing/ChkEntityTemplateExist', { entityType: 'PatchCord', entitysubType: '' }, true, function (resp) {
            if (resp.status == "OK") {
