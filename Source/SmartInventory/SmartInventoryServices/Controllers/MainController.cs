...
namespace SmartInventoryServices.Controllers
{
    ...
    public class MainController : ApiController
    {
        ...
        public HttpResponseMessage GetSplicingReport(splicingReport _splicingReport)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    objSplicingIn.source_system_id = _splicingReport.source_system_id;
                    objSplicingIn.source_entity_type = _splicingReport.source_type;
                    objSplicingIn.is_source_start_point = _splicingReport.is_source_connected;
                    objSplicingIn.listConnector = JsonConvert.DeserializeObject<List<connectors>>(_splicingReport.connecting_entity);
                    string connector = objSplicingIn.listConnector.First().entity_type.ToUpper();
                    objSplicingIn.destination_system_id = _splicingReport.destination_system_id;
                    objSplicingIn.destination_entity_type = _splicingReport.destination_type;
                    objSplicingIn.is_destination_start_point = _splicingReport.is_destination_connected;
                    objSplicingIn.customer_ids = _splicingReport.customer_Ids;
                    SplicingViewModel splicingEntity = new SplicingViewModel();
                    splicingEntity.splicingConnections = new BLOSPSplicing().getSplicingInfoReport(objSplicingIn, _splicingReport.connecting_entity);
                    ...
                    if (_splicingReport.exportKey == "CPE2C")
                    {
                    ...
                    else if (_splicingReport.exportKey == "FMS2C")
                    {
                ...
                {
                    ErrorLogHelper logHelper = new ErrorLogHelper();
                    logHelper.ApiLogWriter("DownloadExcel()", "Main Controller", objSplicingIn.ToString(), ex);
                }
            }
            else
            {
