    ...
    public class UploadTempPatchPanel : UploadExcel
    {
        ...
        public override ErrorMessage UploadData(DataTable dataTable, UploadSummary summary)
        {
            try
            {
                ...
                {
                    List<TempPatchPanel> lstEntity = DataValidator.GetObjectList<TempPatchPanel>(dataTable, summary);
            ...
            {
                return tempToMainTable.UpdateStatusAndGetError("UploadTempPatchPanel", "Upload Data", ex, summary);

            }
        }
        private ErrorMessage ParallelInsert(int TotalBatchCount, List<TempPatchPanel> lstPatchPanel, UploadSummary summary)
        {
            ErrorMessage errorMessage = new ErrorMessage();
            List<List<TempPatchPanel>> lstChunks = lstPatchPanel.ToChunks(TotalBatchCount).ToList();
            ...
            BLTempPatchPanel blTempPole = new BLTempPatchPanel();
            int batchCount = 0;
