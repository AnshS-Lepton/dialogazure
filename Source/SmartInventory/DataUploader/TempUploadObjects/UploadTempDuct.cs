...
{
    internal class UploadTempDuct : UploadExcel, IUploadKML
    {
        ...
        public override ErrorMessage UploadData(DataTable dataTable, UploadSummary summary)
        {
            try
            {
                ...
                {
                    List<TempDuct> lstEntity = DataValidator.GetObjectList<TempDuct>(dataTable,summary);
