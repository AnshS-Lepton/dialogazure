...
{
    internal class UploadTempCustomerWireless : UploadExcel
    {
        ...
        public UploadTempCustomerWireless()
        {
        ...
        public override ErrorMessage UploadData(DataTable dataTable, UploadSummary summary)
        {
            try
            {
                ...
                {
                    List<TempWirelessCustomer> lstEntity = DataValidator.GetObjectList<TempWirelessCustomer>(dataTable, summary);
        ...
        private ErrorMessage ParallelInsert(int TotalBatchCount, List<TempWirelessCustomer> lstObj, UploadSummary summary)
        {
            ErrorMessage errorMessage = new ErrorMessage();
            List<List<TempWirelessCustomer>> lstChunks = lstObj.ToChunks(TotalBatchCount).ToList();
            ...
            BLWirelessCustomer blTempObj = new BLWirelessCustomer();
            int batchCount = 0;
