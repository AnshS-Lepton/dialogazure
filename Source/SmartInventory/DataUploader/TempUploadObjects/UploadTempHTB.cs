    ...
    internal class UploadTempHTB : UploadExcel
    {
        ...
        public override ErrorMessage UploadData(DataTable dataTable, UploadSummary summary)
        {
            try
            {
                ...
                {
                    List<TempHTB> lstEntity = DataValidator.GetObjectList<TempHTB>(dataTable, summary);
            ...
            {
                return tempToMainTable.UpdateStatusAndGetError("UploadTempHTB", "Upload Data", ex, summary);
            }
        }
        private ErrorMessage ParallelInsert(int TotalBatchCount, List<TempHTB> lstHTB, UploadSummary summary)
        {
            ErrorMessage errorMessage = new ErrorMessage();
            List<List<TempHTB>> lstChunks = lstHTB.ToChunks(TotalBatchCount).ToList();
            ...
            BLTempHTB blTempHTB = new BLTempHTB();
            int batchCount = 0;
