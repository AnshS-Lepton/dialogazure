        ...
        public PODMaster SaveEntityPOD(PODMaster objPODMaster, int userId)
        {
            ...
            try
            {
                ...
                if (objPOD != null)
                {
                    ...
                    objPOD.on_air_date = objPODMaster.on_air_date;
                    objPOD.removed_date = objPODMaster.removed_date;
                    objPOD.tx_type = objPODMaster.tx_type;
                    objPOD.tx_technology = objPODMaster.tx_technology;
                    objPOD.tx_segment = objPODMaster.tx_segment;
                    objPOD.tx_ring = objPODMaster.tx_ring;
                    objPOD.province = objPODMaster.province;
                    objPOD.district = objPODMaster.district;
                    objPOD.depot = objPODMaster.depot;
                    objPOD.ds_division = objPODMaster.ds_division;
                    objPOD.local_authority = objPODMaster.local_authority;
                    objPOD.owner_name = objPODMaster.owner_name;
                    objPOD.access_24_7 = objPODMaster.access_24_7;
                    objPOD.tower_type = objPODMaster.tower_type;
                    objPOD.tower_height = objPODMaster.tower_height;
                    objPOD.cabinet_type = objPODMaster.cabinet_type;
                    objPOD.solution_type = objPODMaster.solution_type;
                    objPOD.site_rank = objPODMaster.site_rank;
                    objPOD.self_tx_traffic = objPODMaster.self_tx_traffic;
                    objPOD.agg_tx_traffic = objPODMaster.agg_tx_traffic;
                    objPOD.csr_count = objPODMaster.csr_count;
